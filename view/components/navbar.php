      ...
      <div class="collapse navbar-collapse" id="navbarTogglerDemo03">
        <ul class="navbar-nav mr-auto d-flex justify-content-around align-items-center container-fluid">
          ...
          <li class="nav-item">
            ...
            <div class="btn-group">
              <button type="button" class="btn dropdown-toggle d-flex" data-bs-toggle="dropdown" aria-expanded="false">
                <img src="assets/icons/profileIcon.svg" class="align-self-center" alt=""><a class="text-light nav-link " href="#">User</a>
              </button>
