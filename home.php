...
?>
      ...
      <div class="row d-flex justify-content-around">
        <div class="align-self-center col-xs-10 col-12 col-xl-12 col-xxl-4">
          ...
          <p class="text-light fw-light display-6">We provide an interactive experience in which a real world
            ...
            <!-- signUP -->
            <?php include("/xampp/htdocs/makeATry/view/components/signUp.php")?>
            <div class="col-1"></div>
            <!-- login -->
            <?php 
            if(!isset($_SESSION['user_email']) && !isset($_SESSION['user_id'])){
              include("/xampp/htdocs/makeATry/view/components/login.php");
             }
            ?>
          </div>
        </div>
  ...
  <!-- footer -->
  <?php include("/xampp/htdocs/makeATry/view/components/footer.php") ?>
